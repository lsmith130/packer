...
type FlatConfig struct {
	...
	Source              string            `cty:"source" hcl:"source,optional"`
	Sources             []string          `cty:"sources" hcl:"sources,optional"`
	Destination         string            `cty:"destination" hcl:"destination,optional"`
	Direction           string            `cty:"direction" hcl:"direction,optional"`
	Generated           bool              `cty:"generated" hcl:"generated,optional"`
}
