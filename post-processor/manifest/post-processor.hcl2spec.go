...
type FlatConfig struct {
	...
	StripPath           bool              `mapstructure:"strip_path" cty:"strip_path" hcl:"strip_path,optional"`
	CustomData          map[string]string `mapstructure:"custom_data" cty:"custom_data" hcl:"custom_data,optional"`
}
