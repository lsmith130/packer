...
type FlatConfig struct {
	...
	OSSBucket                         string                   `mapstructure:"oss_bucket_name" cty:"oss_bucket_name" hcl:"oss_bucket_name,optional"`
	OSSKey                            string                   `mapstructure:"oss_key_name" cty:"oss_key_name" hcl:"oss_key_name,optional"`
	...
	OSType                            string                   `mapstructure:"image_os_type" cty:"image_os_type" hcl:"image_os_type,optional"`
	Platform                          string                   `mapstructure:"image_platform" cty:"image_platform" hcl:"image_platform,optional"`
	Architecture                      string                   `mapstructure:"image_architecture" cty:"image_architecture" hcl:"image_architecture,optional"`
	Size                              string                   `mapstructure:"image_system_size" cty:"image_system_size" hcl:"image_system_size,optional"`
