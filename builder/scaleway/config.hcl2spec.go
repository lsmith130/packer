...
type FlatConfig struct {
	...
	Token                     string            `mapstructure:"api_token" required:"true" cty:"api_token" hcl:"api_token,optional"`
	Organization              string            `mapstructure:"organization_id" required:"true" cty:"organization_id" hcl:"organization_id,optional"`
	...
	CommercialType            string            `mapstructure:"commercial_type" required:"true" cty:"commercial_type" hcl:"commercial_type,optional"`
	...
	ServerName                string            `mapstructure:"server_name" required:"false" cty:"server_name" hcl:"server_name,optional"`
	Bootscript                string            `mapstructure:"bootscript" required:"false" cty:"bootscript" hcl:"bootscript,optional"`
	BootType                  string            `mapstructure:"boottype" required:"false" cty:"boottype" hcl:"boottype,optional"`
	RemoveVolume              bool              `mapstructure:"remove_volume" cty:"remove_volume" hcl:"remove_volume,optional"`
	UserAgent                 string            `cty:"user_agent" hcl:"user_agent,optional"`
}
