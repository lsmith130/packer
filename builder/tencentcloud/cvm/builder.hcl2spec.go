...
type FlatConfig struct {
	...
	SecretId                  string                 `mapstructure:"secret_id" required:"true" cty:"secret_id" hcl:"secret_id,optional"`
	SecretKey                 string                 `mapstructure:"secret_key" required:"true" cty:"secret_key" hcl:"secret_key,optional"`
	Region                    string                 `mapstructure:"region" required:"true" cty:"region" hcl:"region,optional"`
	...
	Reboot                    bool                   `mapstructure:"reboot" required:"false" cty:"reboot" hcl:"reboot,optional"`
	ForcePoweroff             bool                   `mapstructure:"force_poweroff" required:"false" cty:"force_poweroff" hcl:"force_poweroff,optional"`
	Sysprep                   bool                   `mapstructure:"sysprep" required:"false" cty:"sysprep" hcl:"sysprep,optional"`
	ImageForceDelete          bool                   `mapstructure:"image_force_delete" cty:"image_force_delete" hcl:"image_force_delete,optional"`
	ImageCopyRegions          []string               `mapstructure:"image_copy_regions" required:"false" cty:"image_copy_regions" hcl:"image_copy_regions,optional"`
	ImageShareAccounts        []string               `mapstructure:"image_share_accounts" required:"false" cty:"image_share_accounts" hcl:"image_share_accounts,optional"`
	...
	SourceImageId             string                 `mapstructure:"source_image_id" required:"true" cty:"source_image_id" hcl:"source_image_id,optional"`
	...
	DataDisks                 []tencentCloudDataDisk `mapstructure:"data_disks" cty:"data_disks" hcl:"data_disks,optional"`
	...
	VpcIp                     string                 `mapstructure:"vpc_ip" cty:"vpc_ip" hcl:"vpc_ip,optional"`
	SubnetId                  string                 `mapstructure:"subnet_id" required:"false" cty:"subnet_id" hcl:"subnet_id,optional"`
	SubnetName                string                 `mapstructure:"subnet_name" required:"false" cty:"subnet_name" hcl:"subnet_name,optional"`
	CidrBlock                 string                 `mapstructure:"cidr_block" required:"false" cty:"cidr_block" hcl:"cidr_block,optional"`
	SubnectCidrBlock          string                 `mapstructure:"subnect_cidr_block" required:"false" cty:"subnect_cidr_block" hcl:"subnect_cidr_block,optional"`
	InternetChargeType        string                 `mapstructure:"internet_charge_type" cty:"internet_charge_type" hcl:"internet_charge_type,optional"`
	InternetMaxBandwidthOut   int64                  `mapstructure:"internet_max_bandwidth_out" required:"false" cty:"internet_max_bandwidth_out" hcl:"internet_max_bandwidth_out,optional"`
	...
	HostName                  string                 `mapstructure:"host_name" required:"false" cty:"host_name" hcl:"host_name,optional"`
	...
	SSHPrivateIp              bool                   `mapstructure:"ssh_private_ip" cty:"ssh_private_ip" hcl:"ssh_private_ip,optional"`
}
