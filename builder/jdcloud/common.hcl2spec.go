...
type FlatConfig struct {
	...
	RegionId                  string            `mapstructure:"region_id" cty:"region_id" hcl:"region_id,optional"`
	Az                        string            `mapstructure:"az" cty:"az" hcl:"az,optional"`
	ImageId                   string            `mapstructure:"image_id" cty:"image_id" hcl:"image_id,optional"`
	...
	InstanceId                string            `cty:"instance_id" hcl:"instance_id,optional"`
	ArtifactId                string            `cty:"artifact_id" hcl:"artifact_id,optional"`
	PublicIpAddress           string            `cty:"public_ip_address" hcl:"public_ip_address,optional"`
	PublicIpId                string            `cty:"public_ip_id" hcl:"public_ip_id,optional"`
