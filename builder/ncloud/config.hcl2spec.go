...
type FlatConfig struct {
	...
	ServerImageProductCode            string            `mapstructure:"server_image_product_code" required:"true" cty:"server_image_product_code" hcl:"server_image_product_code,optional"`
	ServerProductCode                 string            `mapstructure:"server_product_code" required:"true" cty:"server_product_code" hcl:"server_product_code,optional"`
	MemberServerImageNo               string            `mapstructure:"member_server_image_no" required:"false" cty:"member_server_image_no" hcl:"member_server_image_no,optional"`
	ServerImageName                   string            `mapstructure:"server_image_name" required:"false" cty:"server_image_name" hcl:"server_image_name,optional"`
	ServerImageDescription            string            `mapstructure:"server_image_description" required:"false" cty:"server_image_description" hcl:"server_image_description,optional"`
	...
	BlockStorageSize                  int               `mapstructure:"block_storage_size" required:"false" cty:"block_storage_size" hcl:"block_storage_size,optional"`
	Region                            string            `mapstructure:"region" required:"false" cty:"region" hcl:"region,optional"`
	AccessControlGroupConfigurationNo string            `mapstructure:"access_control_group_configuration_no" required:"false" cty:"access_control_group_configuration_no" hcl:"access_control_group_configuration_no,optional"`
