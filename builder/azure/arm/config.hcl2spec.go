...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"shared_image_gallery":                     &hcldec.BlockObjectSpec{TypeName: "SharedImageGallery", Nested: hcldec.ObjectSpec((*SharedImageGallery)(nil).HCL2Spec())},
		"shared_image_gallery_destination":         &hcldec.BlockObjectSpec{TypeName: "SharedImageGalleryDestination", Nested: hcldec.ObjectSpec((*SharedImageGalleryDestination)(nil).HCL2Spec())},
		...
		"plan_info":                                &hcldec.BlockObjectSpec{TypeName: "PlanInformation", Nested: hcldec.ObjectSpec((*PlanInformation)(nil).HCL2Spec())},
