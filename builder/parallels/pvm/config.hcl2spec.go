...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"prlctl":                       &hcldec.AttrSpec{Name: "prlctl", Type: cty.List(&hcldec.AttrSpec{Name: "[]string", Type: cty.List(cty.String), Required: false})},
		"prlctl_post":                  &hcldec.AttrSpec{Name: "prlctl_post", Type: cty.List(&hcldec.AttrSpec{Name: "[]string", Type: cty.List(cty.String), Required: false})},
