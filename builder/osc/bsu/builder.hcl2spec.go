...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"launch_block_device_mappings":         &hcldec.BlockListSpec{TypeName: "[]common.BlockDevice", Nested: &hcldec.BlockObjectSpec{TypeName: "common.BlockDevice", Nested: hcldec.ObjectSpec((*common.BlockDevice)(nil).HCL2Spec())}},
		...
		"security_group_filter":                &hcldec.BlockObjectSpec{TypeName: "common.SecurityGroupFilterOptions", Nested: hcldec.ObjectSpec((*common.SecurityGroupFilterOptions)(nil).HCL2Spec())},
		...
		"subnet_filter":                        &hcldec.BlockObjectSpec{TypeName: "common.SubnetFilterOptions", Nested: hcldec.ObjectSpec((*common.SubnetFilterOptions)(nil).HCL2Spec())},
		...
		"net_filter":                           &hcldec.BlockObjectSpec{TypeName: "common.NetFilterOptions", Nested: hcldec.ObjectSpec((*common.NetFilterOptions)(nil).HCL2Spec())},
