...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"bsu_volumes":                          &hcldec.BlockListSpec{TypeName: "[]BlockDevice", Nested: &hcldec.BlockObjectSpec{TypeName: "BlockDevice", Nested: hcldec.ObjectSpec((*BlockDevice)(nil).HCL2Spec())}},
	}
	return s
}
