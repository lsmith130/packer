...
type FlatConfig struct {
	...
	APIToken                  string            `mapstructure:"api_token" required:"true" cty:"api_token" hcl:"api_token,optional"`
	...
	Size                      string            `mapstructure:"size" required:"true" cty:"size" hcl:"size,optional"`
	Image                     string            `mapstructure:"image" required:"true" cty:"image" hcl:"image,optional"`
	PrivateNetworking         bool              `mapstructure:"private_networking" required:"false" cty:"private_networking" hcl:"private_networking,optional"`
	Monitoring                bool              `mapstructure:"monitoring" required:"false" cty:"monitoring" hcl:"monitoring,optional"`
	IPv6                      bool              `mapstructure:"ipv6" required:"false" cty:"ipv6" hcl:"ipv6,optional"`
	SnapshotName              string            `mapstructure:"snapshot_name" required:"false" cty:"snapshot_name" hcl:"snapshot_name,optional"`
	SnapshotRegions           []string          `mapstructure:"snapshot_regions" required:"false" cty:"snapshot_regions" hcl:"snapshot_regions,optional"`
	StateTimeout              time.Duration     `mapstructure:"state_timeout" required:"false" cty:"state_timeout" hcl:"state_timeout,optional"`
	SnapshotTimeout           time.Duration     `mapstructure:"snapshot_timeout" required:"false" cty:"snapshot_timeout" hcl:"snapshot_timeout,optional"`
	DropletName               string            `mapstructure:"droplet_name" required:"false" cty:"droplet_name" hcl:"droplet_name,optional"`
