...
type FlatConfig struct {
	...
	PersonalAccessToken       string            `mapstructure:"linode_token" cty:"linode_token" hcl:"linode_token,optional"`
	...
	Label                     string            `mapstructure:"instance_label" cty:"instance_label" hcl:"instance_label,optional"`
	Tags                      []string          `mapstructure:"instance_tags" cty:"instance_tags" hcl:"instance_tags,optional"`
	Image                     string            `mapstructure:"image" cty:"image" hcl:"image,optional"`
	SwapSize                  int               `mapstructure:"swap_size" cty:"swap_size" hcl:"swap_size,optional"`
	RootPass                  string            `mapstructure:"root_pass" cty:"root_pass" hcl:"root_pass,optional"`
	RootSSHKey                string            `mapstructure:"root_ssh_key" cty:"root_ssh_key" hcl:"root_ssh_key,optional"`
	ImageLabel                string            `mapstructure:"image_label" cty:"image_label" hcl:"image_label,optional"`
	Description               string            `mapstructure:"image_description" cty:"image_description" hcl:"image_description,optional"`
	RawStateTimeout           string            `mapstructure:"state_timeout" cty:"state_timeout" hcl:"state_timeout,optional"`
}
