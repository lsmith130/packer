// Code generated by "mapstructure-to-hcl2 -type Config,VaultAWSEngineOptions,BlockDevices"; DO NOT EDIT.
package chroot
...
type FlatConfig struct {
	...
	AMIMappings             BlockDevices                 `mapstructure:"ami_block_device_mappings" hcl2-schema-generator:"ami_block_device_mappings,direct" required:"false" cty:"ami_block_device_mappings"`
...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"AMIMappings":             hcldec.BlockListSpec{TypeName: "[]BlockDevice", Nested: &hcldec.BlockObjectSpec{TypeName: "BlockDevice", Nested: hcldec.ObjectSpec((*BlockDevice)(nil).HCL2Spec())}},
