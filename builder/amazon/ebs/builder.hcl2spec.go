...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"source_ami_filter":                     &hcldec.BlockObjectSpec{TypeName: "common.AmiFilterOptions", Nested: hcldec.ObjectSpec((*common.AmiFilterOptions)(nil).HCL2Spec())},
		...
		"vpc_filter":                            &hcldec.BlockObjectSpec{TypeName: "common.VpcFilterOptions", Nested: hcldec.ObjectSpec((*common.VpcFilterOptions)(nil).HCL2Spec())},
		...
		"ami_block_device_mappings":             &hcldec.BlockListSpec{TypeName: "[]common.BlockDevice", Nested: &hcldec.BlockObjectSpec{TypeName: "common.BlockDevice", Nested: hcldec.ObjectSpec((*common.BlockDevice)(nil).HCL2Spec())}},
