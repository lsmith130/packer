...
type FlatConfig struct {
	...
	Url                       string            `mapstructure:"url" cty:"url" hcl:"url,optional"`
	SnapshotName              string            `mapstructure:"image_name" cty:"image_name" hcl:"image_name,optional"`
	DataCenterName            string            `mapstructure:"data_center_name" cty:"data_center_name" hcl:"data_center_name,optional"`
	DataCenterId              string            `cty:"data_center_id" hcl:"data_center_id,optional"`
	Image                     string            `mapstructure:"source_image_name" cty:"source_image_name" hcl:"source_image_name,optional"`
