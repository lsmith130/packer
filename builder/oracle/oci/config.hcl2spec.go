...
type FlatConfig struct {
	...
	AccessCfgFile             string                            `mapstructure:"access_cfg_file" cty:"access_cfg_file" hcl:"access_cfg_file,optional"`
	AccessCfgFileAccount      string                            `mapstructure:"access_cfg_file_account" cty:"access_cfg_file_account" hcl:"access_cfg_file_account,optional"`
	UserID                    string                            `mapstructure:"user_ocid" cty:"user_ocid" hcl:"user_ocid,optional"`
	TenancyID                 string                            `mapstructure:"tenancy_ocid" cty:"tenancy_ocid" hcl:"tenancy_ocid,optional"`
	Region                    string                            `mapstructure:"region" cty:"region" hcl:"region,optional"`
	Fingerprint               string                            `mapstructure:"fingerprint" cty:"fingerprint" hcl:"fingerprint,optional"`
	KeyFile                   string                            `mapstructure:"key_file" cty:"key_file" hcl:"key_file,optional"`
	PassPhrase                string                            `mapstructure:"pass_phrase" cty:"pass_phrase" hcl:"pass_phrase,optional"`
	UsePrivateIP              bool                              `mapstructure:"use_private_ip" cty:"use_private_ip" hcl:"use_private_ip,optional"`
	AvailabilityDomain        string                            `mapstructure:"availability_domain" cty:"availability_domain" hcl:"availability_domain,optional"`
	CompartmentID             string                            `mapstructure:"compartment_ocid" cty:"compartment_ocid" hcl:"compartment_ocid,optional"`
	BaseImageID               string                            `mapstructure:"base_image_ocid" cty:"base_image_ocid" hcl:"base_image_ocid,optional"`
	...
	InstanceName              string                            `mapstructure:"instance_name" cty:"instance_name" hcl:"instance_name,optional"`
	Metadata                  map[string]string                 `mapstructure:"metadata" cty:"metadata" hcl:"metadata,optional"`
	...
	SubnetID                  string                            `mapstructure:"subnet_ocid" cty:"subnet_ocid" hcl:"subnet_ocid,optional"`
	Tags                      map[string]string                 `mapstructure:"tags" cty:"tags" hcl:"tags,optional"`
	DefinedTags               map[string]map[string]interface{} `mapstructure:"defined_tags" cty:"defined_tags" hcl:"defined_tags,optional"`
}
