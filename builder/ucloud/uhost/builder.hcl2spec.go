...
type FlatConfig struct {
	...
	PublicKey                 string             `mapstructure:"public_key" cty:"public_key" hcl:"public_key,optional"`
	PrivateKey                string             `mapstructure:"private_key" cty:"private_key" hcl:"private_key,optional"`
	...
	BaseUrl                   string             `mapstructure:"base_url" cty:"base_url" hcl:"base_url,optional"`
	...
	ImageDestinations         []ImageDestination `mapstructure:"image_copy_to_mappings" cty:"image_copy_to_mappings" hcl:"image_copy_to_mappings,optional"`
	Zone                      string             `mapstructure:"availability_zone" cty:"availability_zone" hcl:"availability_zone,optional"`
	SourceImageId             string             `mapstructure:"source_image_id" cty:"source_image_id" hcl:"source_image_id,optional"`
	InstanceType              string             `mapstructure:"instance_type" cty:"instance_type" hcl:"instance_type,optional"`
	InstanceName              string             `mapstructure:"instance_name" cty:"instance_name" hcl:"instance_name,optional"`
	BootDiskType              string             `mapstructure:"boot_disk_type" cty:"boot_disk_type" hcl:"boot_disk_type,optional"`
	VPCId                     string             `mapstructure:"vpc_id" cty:"vpc_id" hcl:"vpc_id,optional"`
	...
	UseSSHPrivateIp           bool               `mapstructure:"use_ssh_private_ip" cty:"use_ssh_private_ip" hcl:"use_ssh_private_ip,optional"`
}
