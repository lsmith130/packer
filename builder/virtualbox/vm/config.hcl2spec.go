...
type FlatConfig struct {
	...
	GuestAdditionsMode        string            `mapstructure:"guest_additions_mode" cty:"guest_additions_mode" hcl:"guest_additions_mode,optional"`
	GuestAdditionsPath        string            `mapstructure:"guest_additions_path" cty:"guest_additions_path" hcl:"guest_additions_path,optional"`
	GuestAdditionsSHA256      string            `mapstructure:"guest_additions_sha256" cty:"guest_additions_sha256" hcl:"guest_additions_sha256,optional"`
	GuestAdditionsURL         string            `mapstructure:"guest_additions_url" cty:"guest_additions_url" hcl:"guest_additions_url,optional"`
	VMName                    string            `mapstructure:"vm_name" cty:"vm_name" hcl:"vm_name,optional"`
	AttachSnapshot            string            `mapstructure:"attach_snapshot" cty:"attach_snapshot" hcl:"attach_snapshot,optional"`
	TargetSnapshot            string            `mapstructure:"target_snapshot" cty:"target_snapshot" hcl:"target_snapshot,optional"`
	DeleteTargetSnapshot      bool              `mapstructure:"force_delete_snapshot" cty:"force_delete_snapshot" hcl:"force_delete_snapshot,optional"`
	KeepRegistered            bool              `mapstructure:"keep_registered" cty:"keep_registered" hcl:"keep_registered,optional"`
	SkipExport                bool              `mapstructure:"skip_export" cty:"skip_export" hcl:"skip_export,optional"`
}
