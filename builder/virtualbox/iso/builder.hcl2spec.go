...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"vboxmanage":                   &hcldec.AttrSpec{Name: "vboxmanage", Type: cty.List(&hcldec.AttrSpec{Name: "[]string", Type: cty.List(cty.String), Required: false})},
		"vboxmanage_post":              &hcldec.AttrSpec{Name: "vboxmanage_post", Type: cty.List(&hcldec.AttrSpec{Name: "[]string", Type: cty.List(cty.String), Required: false})},
